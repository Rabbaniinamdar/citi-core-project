...
public class Account {
    ...
    private Account(Builder builder) {
        ...
        this.isFdAutoRenew = builder.isFdAutoRenew;
    ...
    public Boolean getFdAutoRenew() {
        return isFdAutoRenew;
    }

    public void setFdAutoRenew(Boolean fdAutoRenew) {
        isFdAutoRenew = fdAutoRenew;
    }
